...
public class DragSortListView extends ListView {
	...
	public void initStyle() {
		FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(
				...
				LayoutParams.MATCH_PARENT);
//		lp.setMargins(0, getResources().getDimensionPixelSize(R.dimen.topbar_height), 0, 0);
...
//
//        if (attrs != null) {
////            TypedArray a = QMApplicationContext.sharedInstance().obtainStyledAttributes(attrs, R.styleable.DragSortListView, 0, 0);
////
...
//        };
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                if (child instanceof Checkable) {
                    v = new DragSortItemView2(getContext());
                } else {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
    	...
    	//动画的时候需要锁定scroll,这里添加一个设定
    	if(mLockScroll && ev.getAction() == MotionEvent.ACTION_MOVE){
    		return true;
    	}
